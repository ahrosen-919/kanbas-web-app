        ...
        <thead>
          ...
          <tr>
            <td> 
              ...
              <input placeholder="pasword" className="form-control" value={user.password} onChange={(e) => setUser({ ...user, password: e.target.value })}/>
            </td>
            <td>
            ...
            <td>
                 <button className="btn" onClick={updateUser}><BsFillCheckCircleFill className="me-1 text-success fs-3 " /></button>

              <button className="btn" onClick={createUser}> <BsPlusCircleFill className="me-1 text-success fs-3"/> </button>
            </td>
          </tr>
        ...
        <tbody>
          {users.map((user) => (
            <tr key={user._id}>
              ...
              <td>{user.lastName}</td>
              <td> 
                <button onClick={() => selectUser(user)} className="btn btn-warning me-1"><BsPencil /></button>
